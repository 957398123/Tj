public abstract class Cons {
  ...
  public static short[][] SKILL_APOTHECARY = new short[][] { 
      { 1, 0, 0, 0, 0, 0, 0 },       // 近身攻击   敌人
      { 3, 7, 80, 35, 2, 0, 5 },     // 飓风之牙   敌人
      { 3, 2, 80, 60, 2, 0, 10 },    // 心疗术     队友or自己
      { 3, 2, 80, 200, 2, 0, 10 },   // 清心灵咒   队友or自己
      { 3, 2, 80, 100, 1, 0, 10 },   // 回春术     队友or自己
      { 3, 6, 0, 200, 5, 0, 15 },    // 天降甘霖   范围技
      { 1, 0, 0, 0, 0, 0, 0 },       // 神农心法   被动
      { 3, 7, 80, 55, 0, 1, 5 },     // 猛毒蛊     敌人
      { 3, 7, 80, 150, 0, 14, 15 },  // 鬼灵地缚   敌人
      { 3, 7, 60, 50, 0, 10, 6 },    // 天破龙卷   敌人
      { 3, 5, 60, 100, 4, 0, 10 },   // 疾风之翼   队友or自己
      { 3, 3, 60, 100, 0, 168, 10 }, // 黄帝内经   队友
      { 3, 5, 60, 60, 3, 0, 8 },     // 灵甲真言   队友or自己
      { 3, 3, 80, 200, 10, 0, 0 },   // 起死回生   队友
      { 3, 5, 80, 65, 0, 2, 5 }      // 愈合之契   队友or自己
  };
